                ...
                <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                    ...
                    <div class="navbar-vertical-content">
                        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="<?= base_url('algoritma/#/akses') ?>" role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon">
                                            <span data-feather="lock"></span>
                                        </span>
                                        <span class="nav-link-text-wrapper"><span class="nav-link-text">Akses</span>
                                        </span>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="<?= base_url('algoritma/#/pengaturan') ?>" role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon">
                                            <span data-feather="settings"></span>
                                        </span>
                                        <span class="nav-link-text-wrapper"><span class="nav-link-text">Pengaturan</span>
                                        </span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="collapse navbar-collapse justify-content-between">
                    <div class="navbar-logo">
                        ...
                        <a class="navbar-brand me-1 me-sm-3" href="index.html">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center"><img src="<?= base_url('assets/logo/informatika.png') ?>" alt="phoenix" width="27" />
                                ...
                                <div class="card position-relative border-0">
                                    ...
                                    <div class="overflow-auto scrollbar">
                                        <ul class="nav d-flex flex-column mb-2 pb-1">
                                            <li class="nav-item">
                                                <a class="nav-link px-3" href="#/profil"> <span class="me-2 text-900" data-feather="user"></span>Profile</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link px-3" href="#/home"><span class="me-2 text-900" data-feather="pie-chart"></span>Dashboard</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link px-3" href="#/pengaturan"> <span class="me-2 text-900" data-feather="settings"></span>Settings &amp; Privacy </a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <nav class="navbar navbar-top navbar-expand-lg" id="navbarTopNew" style="display:none;">
                ...
                <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarToplCollapse">
                    <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="master">Pengaturan</a>
                            <div class="dropdown-menu navbar-dropdown-caret py-0" aria-labelledby="master">
                                <div class="dropdown-menu-content py-2">
                                    <a class="dropdown-item fw-semi-bold" href="#/akses">Akses</a>
                                    <a class="dropdown-item fw-semi-bold" href="#/pengaturan">Pengaturan</a>
                                </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarToplCollapse">
                    <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dashboards">Dashboard</a>
                            <div class="dropdown-menu navbar-dropdown-caret py-0" aria-labelledby="dashboards">
                                <div class="dropdown-menu-content py-2">
                                    <a class="dropdown-item fw-semi-bold" href="#/home">Home</a>
                                    <a class="dropdown-item fw-semi-bold" href="#/profil">Data Diri</a>
                                </div>
                        </li>
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="master">Master</a>
                            <div class="dropdown-menu navbar-dropdown-caret py-0" aria-labelledby="master">
                                    ...
                                    <div class="scrollbar max-h-dropdown">
                                        <div class="row gx-0">
                                            <?php foreach ($menu as $get) : ?>
                                                <div class="col-12">
                                                    <div class="nav flex-column">
                                                        <p class="nav-link mb-0 fw-bold text-danger"><?= $get['nama_menu'] ?></p>
                                                        <?php $data = $this->db->get_where('master_kategori', ['id_menu' => $get['id_menu']])->result_array(); ?>
                                                        <?php foreach ($data as $val) : ?>
                                                            <a class="nav-link fw-semi-bold" href="#/detail_kategori/<?= $val['id_kategori'] . "/" . $val['kode_kategori'] ?>">
                                                                <?= $val['nama_kategori'] ?>
                                                        ...
                                                        <?php endforeach; ?>
                                                        <!-- <a class="nav-link fw-semi-bold" href="apps/e-commerce/admin/add-product.html">Add product</a> -->
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
                                        </div>
