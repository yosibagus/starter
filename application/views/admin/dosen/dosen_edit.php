        ...
        <form method="POST" action="" enctype="multipart/form-data" id="form-dosen" class="row g-3 mb-6">
            <div class="col-sm-6">
                <div class="form-floating">
                    <input class="form-control" id="nama_dosen" name="nama_dosen" autocomplete="off" type="text" placeholder="Nama Dosen" value="<?= $dosen['nama_dosen'] ?>" />
                    <label for="nama_dosen">Nama Dosen</label>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-floating">
                    <input class="form-control" name="nik_dosen" id="nik_dosen" autocomplete="off" type="text" placeholder="NIK Dosen" value="<?= $dosen['nip_dosen'] ?>" />
            ...
            <div class="col-sm-6">
                ...
                <a href="<?= base_url('assets/foto/') . $dosen['foto_dosen'] ?>"><i><small>File origin : <?= $dosen['foto_dosen'] ?></small></i></a>
            </div>
            <div class="col-sm-6">
                <div class="form-floating">
                    <input class="form-control" name="jabatan" id="jabatan" autocomplete="off" type="text" placeholder="Jabatan" value="<?= $dosen['jabatan'] ?>" />
                    <label for="jabatan">Jabatan</label>
                </div>
            </div>
            <input type="text" name="id_dosen" id="id_dosen" hidden value="<?= $dosen['id_dosen'] ?>">
